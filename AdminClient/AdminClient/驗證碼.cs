...
namespace AdminClient
{
    class 驗證碼
    {
        ...
        public static void CreatImage(string strValidCode,PictureBox pictureBox)
        {
            try
            {
                int RandomAngle = 30;
                ...
                //字型
                string[] font = { "Verdana", "Microsoft Sans Serif", "Comic Sans MS", "Arial", "微軟正黑體","Consolas" };
                for (int i = 0; i < chars.Length; i++)
                {
                    ...
                    graphics.RotateTransform(-angle);
                    graphics.TranslateTransform(8, -point.Y);
                }
