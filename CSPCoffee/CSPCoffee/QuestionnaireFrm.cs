...
namespace CSPCoffee
{
    public partial class QuestionnaireFrm : Form
    {
        ...
        {
            if(this.comboBox1.Text == "請選擇")
            {
                MessageBox.Show("第一題尚未選擇");
            }
            else if(this.comboBox2.Text == "請選擇")
            {
                MessageBox.Show("第二題尚未選擇");
            }
            else if (this.comboBox3.Text == "請選擇")
            {
                MessageBox.Show("第三題尚未選擇");
            }
            else if (this.comboBox4.Text == "請選擇")
            {
                MessageBox.Show("第四題尚未選擇");
            }
            else if (this.comboBox5.Text == "請選擇")
            {
                MessageBox.Show("第五題尚未選擇");
            }
            else if (this.comboBox6.Text == "請選擇")
            {
                MessageBox.Show("第六題尚未選擇");
            }
            else if (this.comboBox7.Text == "請選擇")
            {
            ...
            else
            {
                ...
                if (f1.memberID != 0)
                {
                    var q = this.db.CouponDetails.Any(x => x.MemberID == f1.memberID);
